...
0.42.0 (2025-03-28)
-------------------
* refactor(skku_sensor_kit_launch): remove reference to tamagawa_imu_driver (`#10 <https://github.com/autowarefoundation/skku_sensor_kit_launch/issues/10>`_)
* Contributors: Esteve Fernandez, M. Fatih Cırıt

0.41.0 (2025-02-12)
-------------------
* Merge remote-tracking branch 'origin/main' into humble
* fix(skku_sensor_kit_launch): add autoware prefix to vehicle_velocity_converter (`#5 <https://github.com/autowarefoundation/skku_sensor_kit_launch/issues/5>`_)
