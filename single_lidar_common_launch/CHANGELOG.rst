...
* feat: rename velodyne_monitor with autoware_velodyne_monitor (`#7 <https://github.com/autowarefoundation/skku_sensor_kit_launch/issues/7>`_)
* refactor(glog_component): prefix package and namespace with autoware (`#4 <https://github.com/autowarefoundation/skku_sensor_kit_launch/issues/4>`_)
* Contributors: Esteve Fernandez, Ryohsuke Mitsudome

0.39.0 (2024-12-12)
-------------------
* feature(single_lidar_common_launch): load from parameter (`#3 <https://github.com/autowarefoundation/skku_sensor_kit_launch/issues/3>`_)
* chore(nebula_node_container): make launcher work with Nebula v0.2.0 (`#2 <https://github.com/autowarefoundation/skku_sensor_kit_launch/issues/2>`_)
* feat(skku_sensor_kit): add skku_sensor_kit
